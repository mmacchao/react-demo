...
export default class Home extends Component {
  ...
  render() {
    ...
    const data = (
      <div className="box">
        ...
        <div className="clearfix">
          <a className="pull-left" href="#" onClick={this.togglePage.bind(this, '注册')} >注册</a>
          <a className="pull-right" href="#" onClick={this.togglePage.bind(this, '登陆')}>登陆</a>
        </div>
        {/*主体*/}
        <div>
          <p>
    ...
    return (error_msg || success_msg) ? tip : data
  }
}
